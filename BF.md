                                ...
                                {            
                                    ...
                                    ["fields"]= {
                                        ...
                                        },
                                        {
                                            ...
                                            ["value"]= "```Người dùng đã chạy Kaduski Hub  Hub Auto Farm Cảm Ơn Vì Đã Dùng RinX!!!!```",
                                            ["inline"]= true
                                            },
                                       {
                                     ["name"] = "𝙅𝙤𝙗 𝙄𝙙",
...
local Tabs = {
    Main = Window:AddTab({ Title = "Main", Icon = "rbxassetid://109449124728527" }),
    Setting = Window:AddTab({ Title = "Setting", Icon = "rbxassetid://109449124728527" }),
    Stats = Window:AddTab({ Title = "Stats", Icon = "rbxassetid://109449124728527" }),
    Player = Window:AddTab({ Title = "Player", Icon = "rbxassetid://109449124728527" }),
    Teleport = Window:AddTab({ Title = "Teleport", Icon = "rbxassetid://109449124728527" }),
    Fruit = Window:AddTab({ Title = "Fruit", Icon = "rbxassetid://109449124728527" }),
    Raid = Window:AddTab({ Title = "Raid", Icon = "rbxassetid://109449124728527" }),
    Race = Window:AddTab({ Title = "Race V4", Icon = "rbxassetid://109449124728527" }),
    Shop = Window:AddTab({ Title = "Shop", Icon = "rbxassetid://109449124728527" }),
	Misc = Window:AddTab({ Title = "Misc", Icon = "rbxassetid://109449124728527" }),
}
...
OrionLib:MakeNotification(
        {
            ...
            Image = "rbxassetid://109449124728527",
            Time = 7
        }
    )
_G.lakala = true

setclipboard("Kaduski Hub Is The Best")
	...
	if (getgenv().ED_AntiKick.CheckCaller and not checkcaller() or true) and stringlower(getnamecallmethod()) == "kick" and ED_AntiKick.Enabled then
		if getgenv().ED_AntiKick.SendNotifications then
			StarterGui:SetCore("SendNotification", {
				...
				Icon = "rbxassetid://109449124728527",
				Duration = 2,
			})
		end
...
Tabs.Main:AddButton({
        Title = "Kaduski Hub Discord Server",
...
Fluent:Notify({
    Title = "Kaduski Hub",
    Content = "Thanks For Using Kaduski Hub",
    Duration = 8
})
